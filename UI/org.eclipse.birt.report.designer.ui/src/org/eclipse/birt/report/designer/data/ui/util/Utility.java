...
/**
 * 
 * Utility class to get some useful objects from designer.ui. 
 * For future work to break away data.ui from designer.ui
 */
public class Utility
{
	...
	public static DynamicFilterParameterHandle getDynamicFilterParameter(
			String name )
	{
		if ( name == null )
			return null;
